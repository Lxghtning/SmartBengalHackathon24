...
class Authentication_Services {
  ...
  Future RegisterStudent(String email, String password,String displayName, String years,bool isStudent) async {
    ...
    try {
      ...
      await Database_Services().updateUserData_Profile(uid, email, displayName, years);
    } catch (e) {
      print(e.toString());
    }
  }
  ...
  Future RegisterCounsellor(String countryName, String email, String password,String displayName, String years) async {
    //TODO: Add isStudent field to the database
    try {
      await _auth.createUserWithEmailAndPassword(email: email, password: password);
      await _auth.currentUser!.updateDisplayName(displayName);
